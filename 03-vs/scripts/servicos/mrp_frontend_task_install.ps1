param([ValidateSet("ONLOGON", "ONSTART")][string]$Schedule = "ONLOGON")
...
} catch { Add-MrpLogLine -LogFile $log -Origem "task_install" -Status "ERRO" -Detalhe $_.Exception.Message; throw }
