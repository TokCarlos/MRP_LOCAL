...
Cria/atualiza infrastructure/config/local/admin_auth.local.json com hash PBKDF2-HMAC-SHA256.
"""
...
def resolve_repo_root() -> Path:
    # portable/operations/painel -> subir 2 niveis
...
def main() -> int:
    ...
    local_dir = repo_root / "infrastructure" / "config" / "local"
